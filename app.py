...
model.load_state_dict(torch.load("C:/Users/komsa/OneDrive/Desktop/Bachelor-Thesis/Heroku-Test-Application/pretrained_models/conceptual_weights.pt", map_location=torch.device('cpu')))
model = model.eval()
model = model.to("cpu")


UPLOADED_FILE = "./image/image.jpg"
